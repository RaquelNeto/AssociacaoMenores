	...
	<div class="content-area">
		<main>
			...
			<section class="services">
				<div class="container">
					<h1><?php _e( 'Nossos Serviços', 'association' ); ?></h1>
					<div class="row">
						<div class="col-sm-4">
			...
			<section class="middle-area">
				<div class="container">
					<div class="row">
						<?php get_sidebar( 'home' ); ?> <!-- chama a sidebar -->
						<div class="news col-md-8">
							<div class="news col-md-8">
							<div class="container">
								<h1><?php _e( 'Últimas Notícias', 'association' ); ?> </h1>
								<div class="row">
									<?php 
										/** arg=valor&arg=valor&... */
										/** cat é o id da categoria */
